...
####################
        ...
        pseudo_label=torch.where(predicted1==predicted2,predicted1,pseudo_label)
        i=0

        pseudo_inputs=inputs.cuda()
        for pseudo_label_item in pseudo_label:
            if pseudo_label_item==-1:
...
if __name__ == "__main__":
    ...
    optimizer1_2 = torch.optim.Adam(model1.parameters(), lr=0.00001,betas=(0.9,0.999)) #Optimizer for model 1 in unlabeled training
    optimizer2_2 = torch.optim.Adam(model2.parameters(), lr=0.00001,betas=(0.9,0.999)) #Optimizer for model 2 in unlabeled training
